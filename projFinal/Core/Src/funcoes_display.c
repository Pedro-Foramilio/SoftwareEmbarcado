/* ----------------------------------------------------------------------------
 ...
 Programa: funcoes_display.c -   arquivo de funcoes para o projeto final
 Autor:     Joao Ranhel
 ...
 Usa:  arquivo 'funcoes_display.h" que contem os #defines e prototipos
       das funcoes descritas aqui
/  --------------------------------------------------------------------------*/
#include "main.h"
#include <funcoes_display.h>

extern uint8_t modo;                   // 'modo' definida no main
